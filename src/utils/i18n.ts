  ...
  en: {
    ...
    seo: {
      home: {
        ...
        description:
          "Welcome to the portfolio of Jonas Perusquia Morales, a passionate Chief Technology Officer and Software Engineer specializing in full-stack development, cloud architecture, and leading high-performing engineering teams.",
        keywords: [
        ...
        structuredDescription:
          "Chief Technology Officer and Software Engineer with expertise in full-stack development, cloud architecture, and team leadership.",
      },
    },
  },
  es: {
    ...
    seo: {
      home: {
        title: "Jonas Perusquia Morales - Chief Technology Officer e Ingeniero de Software",
        description:
          "Bienvenido al portafolio de Jonas Perusquia Morales, Chief Technology Officer e ingeniero de software enfocado en desarrollo full stack, arquitectura en la nube y liderazgo de equipos de alto desempeno.",
        keywords: [
          "Jonas Perusquia Morales",
          "CTO",
          "Chief Technology Officer",
        ...
        structuredDescription:
          "Chief Technology Officer e ingeniero de software con experiencia en desarrollo full stack, arquitectura en la nube y liderazgo de equipos.",
      },
    },
  },
};
