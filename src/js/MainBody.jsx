        ...
        return (
            <div className="box body flex flex-column">
                ...
                <div className="flex flex-column align-center">
                    <span>5+ years of expertise working with small and multinational clients, creating and improving the digital experience of businesses and individuals.</span>
                    <h2>Technologies</h2>
